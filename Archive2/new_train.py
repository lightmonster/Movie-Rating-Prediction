...
# df_train['Year'] = np.where(year < 1925, 0, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1925, year < 1935), 1, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1935, year < 1945), 2, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1945, year < 1955), 3, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1955, year < 1965), 4, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1965, year < 1975), 5, year)
# df_train['Year'] = np.where(np.logical_and(year >= 1975, year < 1985), 6, year)
# df_train['Year'] = np.where(year >= 19, 7, year)
